...
import com.studionode.chatwizard.Debug;
...
public class Configuration {
    private static final Plugin instance = ChatWizard.getInstance();
    ...
    private void invalid(String path) {
        ...
        Debug.consoleWarn(message);
        Debug.consoleWarn("Available keys: " + getKeys());
    }
}
